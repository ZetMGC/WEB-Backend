...
<div class="form">
    ...
    <form action="index.php" method="POST" accept-charset="UTF-8" class="login">
        <label>
            ФИО:<br> <input name="fio" <?php if ($errorFlags['fio'] || $errorFlags['symbolfio_error']) {
                print 'class="error"';
        ...
        <label>
            Email:<br />
            <input name="email" <?php if ($errorFlags['email']) {
                print 'class="error"';
        ...
        <label>
            Дата рождения:<br />
            <input name="date" <?php if ($errorFlags['date']) {
                print 'class="error"';
            ...
            <label>Пол:<br />
                ...
                if ($errorFlags['gen']) {print 'class="error"' ;}
            ...
            <label>
                ...
                <select name="languages[]" multiple="multiple" <?php if ($errorFlags['languages_error']) {
                    print 'class="error"';
                } ?>>
            ...
            <label>
                Биография:<br />
                <textarea name="bio" <?php if ($errorFlags['bio']) {
                    print 'class="error"';
